...
public:
    ...
    static void sendPointCloud2(const PointCloud2& scan, asio::io_context& io_context, asio::ip::tcp::socket &socket) {
        asio::ip::tcp::resolver resolver(io_context);
        asio::connect(socket, resolver.resolve("127.0.0.1", std::to_string(8763)));
