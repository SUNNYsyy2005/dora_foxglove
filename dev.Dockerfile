...
FROM build_examples AS laser_scan_server
CMD ["examples/build/Release/laser_scan_server", "/src/examples/autogenerated_flatbuffers/LaserScan.bfbs","/src/examples/autogenerated_flatbuffers/PointCloud.bfbs","/src/examples/autogenerated_flatbuffers/PosesInFrame.bfbs"]
